                    ...
                    <!--Cod Agregago-->
                      ...
                      <li class="active">
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li class="active" ><a href="Edit_Privi.php">Edit Privilege </a></li>
        ...
        <div class="navbar-header">
            ...
            <div>
                ...
                <ul class="nav nav-tabs">
                      <li ><a href="CrearPrivi.php" style="color:#339FFF">New Privilege</a></li>
                        <li><a href="Edit_Privi.php" style="color:#339FFF">Search Privilege</a></li>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox-title">
        <h5>Information of Provilege</h5>
    ...
    <div class="table-responsive">
          ...
          <?php
                ...
                //$conexion=mysqli_connect('localhost','root','','leader');
          			...
          			$consulta= "SELECT * FROM tbl_privilegios";
          			if ($resultado = $mysqli->query($consulta))
          			{
          				while ($fila = $resultado->fetch_row())
          				{
          					...
          					echo"<td>";
          				    echo "<a data-toggle='modal' data-target='#EditContact' data-id='" .$fila[0] ."' data-name='" .$fila[1] ."' data-type='" .$fila[2]."' data-descri='" .$fila[3] ."' class='btn btn-warning'><span class='glyphicon glyphicon-pencil'></span></a> ";
                ...
                <form action="" id="form" method="POST">
                         ...
                         <div class="row">
                                                        ...
                                                        <div class="col-xs-4">
                                                                <div class="input-group">
                                                                     <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                                     <input  type="text" class="form-control" name="descri" id="descri" placeholder="Description">
                                                                </div>
                                                          </div>
                        ...
                        <button type="button" class="btn btn-primary" onclick="EditPrivilege();">Save</button>
...
<div class="footer">
  ...
  <div class="modal inmodal" id="myModal2" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script src="js/templates/privileges.js"></script>
